...
# =========================================================================
        ...
        datos_actualizados = {
            ...
            "V411": {"Presión": f"{dm[dm['Corriente']=='6_Mezcla_Flash']['Presión (atm)'].values[0] if '6_Mezcla_Flash' in dm['Corriente'].values else '1.0'} bar"},
            "K410": {
                "Temp": f"{dm[dm['Corriente']=='7_Vapor']['Temp (°C)'].values[0] if '7_Vapor' in dm['Corriente'].values else '92.17'} °C",
                "Presión": f"{dm[dm['Corriente']=='7_Vapor']['Presión (atm)'].values[0] if '7_Vapor' in dm['Corriente'].values else '1.00'} atm"
            },
